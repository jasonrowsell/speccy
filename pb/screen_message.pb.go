...
type Screen_ScreenType int32

const (
	Screen_UNKNOWN Screen_ScreenType = 0
	Screen_LCD     Screen_ScreenType = 1
	Screen_CRT     Screen_ScreenType = 2
	Screen_OLED    Screen_ScreenType = 3
	Screen_IPS     Screen_ScreenType = 4
)

// Enum value maps for Screen_ScreenType.
var (
	Screen_ScreenType_name = map[int32]string{
		0: "UNKNOWN",
		1: "LCD",
		2: "CRT",
		3: "OLED",
	...
	Screen_ScreenType_value = map[string]int32{
		"UNKNOWN": 0,
		"LCD":     1,
		"CRT":     2,
		"OLED":    3,
...
func (x Screen_ScreenType) Enum() *Screen_ScreenType {
	p := new(Screen_ScreenType)
	*p = x
	return p
}

func (x Screen_ScreenType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Screen_ScreenType) Descriptor() protoreflect.EnumDescriptor {
	return file_screen_message_proto_enumTypes[0].Descriptor()
}

func (Screen_ScreenType) Type() protoreflect.EnumType {
	return &file_screen_message_proto_enumTypes[0]
}

func (x Screen_ScreenType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Screen_ScreenType.Descriptor instead.
func (Screen_ScreenType) EnumDescriptor() ([]byte, []int) {
...
type Screen struct {
	...
	Type           Screen_ScreenType  `protobuf:"varint,3,opt,name=type,proto3,enum=jasonrowsell.speccy.Screen_ScreenType" json:"type,omitempty"`
	HasTouchscreen bool               `protobuf:"varint,4,opt,name=has_touchscreen,json=hasTouchscreen,proto3" json:"has_touchscreen,omitempty"`
}
...
func (x *Screen) GetType() Screen_ScreenType {
	if x != nil {
		return x.Type
	}
...
func (x *Screen) GetHasTouchscreen() bool {
	if x != nil {
...
var file_screen_message_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x68, 0x74, 0x22, 0x3e, 0x0a, 0x0a, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x07,
	0x0a, 0x03, 0x4c, 0x43, 0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x43, 0x52, 0x54, 0x10, 0x02,
	0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x12, 0x07, 0x0a, 0x03, 0x49, 0x50,
	0x53, 0x10, 0x04, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_ScreenType)(0),    // 0: jasonrowsell.speccy.Screen.ScreenType
	(*Screen)(nil),            // 1: jasonrowsell.speccy.Screen
	(*Screen_Resolution)(nil), // 2: jasonrowsell.speccy.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: jasonrowsell.speccy.Screen.resolution:type_name -> jasonrowsell.speccy.Screen.Resolution
	0, // 1: jasonrowsell.speccy.Screen.type:type_name -> jasonrowsell.speccy.Screen.ScreenType
